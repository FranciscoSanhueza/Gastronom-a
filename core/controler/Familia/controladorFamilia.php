...
require_once 'GeneralFamilia.php';
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (isset($_POST['action'])) {
        ...
        if (in_array($valorAction, $gn->getListaAcion())) {
            ...
            switch ($valorAction) {
                case 'comboFamilia'://retorna un producto filtrandolo por su codigo
                    $valor = Familia::ListarFamilia(null);
                    $retorno = "";
                ...
                case 'InsertarProducto'://ingresa productos
                    ...
                    exit;
                    break;
                case 'listarFamilia'://Llena la tabla de productos
                    $valor = Familia::ListarFamilia(null);
                            ...
                            if ($cod == 0) {
                                ...
                                if ($registros[2] == 2) {
                                    $retorno .= "<tr class='danger'>"
                                            ...
                                            //. "<td>" . $registros[2] . "</td>"//Estado
                                            . "<td><i class='fa fa-edit' onclick=modificar(" . $registros[0] . ") style='font-size: 24px; color: green'></i></td>"
                                            . "<td><i class='fas fa-trash-alt' onclick=msjEliminar(" . $registros[0] . ") style='font-size: 24px; color: red'></i></td>"
                                            . "</tr>";
                                } else {
                                    $retorno .= "<tr>"
                                            . "<td>" . $registros[0] . "</td>"//codigo
